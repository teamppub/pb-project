export const data = {
  lists: [
    ...
    {
      id: 6,
      title: 'Manifest: The Sunday Times Bestseller that Will Change Your Life',
      subject: 'Mystery',
      author: 'Roxie Nafousi',
    },
    {
      id: 7,
      title: 'Desperation in Death: An Eve Dallas Thriller (In Death 55)',
      subject: 'Detective',
      author: '노라 로버츠',
    },
    {
